...
JL_FEATURE_DEF(avx512f, 32 * 2 + 16, JL_X86_AVX_MIN_VER)
JL_FEATURE_DEF(avx512dq, 32 * 2 + 17, JL_X86_AVX_MIN_VER)
JL_FEATURE_DEF(rdseed, 32 * 2 + 18, 0)
JL_FEATURE_DEF(adx, 32 * 2 + 19, 0)
// JL_FEATURE_DEF(smap, 32 * 2 + 20, 0) // Not used and gone in LLVM 5.0
JL_FEATURE_DEF(avx512ifma, 32 * 2 + 21, JL_X86_AVX_MIN_VER)
// JL_FEATURE_DEF(pcommit, 32 * 2 + 22, 0) // Deprecated
JL_FEATURE_DEF(clflushopt, 32 * 2 + 23, 0)
JL_FEATURE_DEF(clwb, 32 * 2 + 24, 0)
JL_FEATURE_DEF(avx512pf, 32 * 2 + 26, JL_X86_AVX_MIN_VER)
JL_FEATURE_DEF(avx512er, 32 * 2 + 27, JL_X86_AVX_MIN_VER)
JL_FEATURE_DEF(avx512cd, 32 * 2 + 28, JL_X86_AVX_MIN_VER)
JL_FEATURE_DEF(sha, 32 * 2 + 29, 0)
JL_FEATURE_DEF(avx512bw, 32 * 2 + 30, JL_X86_AVX_MIN_VER)
JL_FEATURE_DEF(avx512vl, 32 * 2 + 31, JL_X86_AVX_MIN_VER)

// EAX=7,ECX=0: ECX
JL_FEATURE_DEF(prefetchwt1, 32 * 3 + 0, 0)
JL_FEATURE_DEF(avx512vbmi, 32 * 3 + 1, JL_X86_AVX_MIN_VER)
